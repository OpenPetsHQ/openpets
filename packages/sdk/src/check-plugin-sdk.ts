...
harness.system.setMetrics({ cpuPercent: 12, memUsedPercent: 34, gpuPercent: 56, diskUsedPercent: 78, battery: { percent: 80, charging: true }, network: { downloadBytesPerSecond: 1024, uploadBytesPerSecond: 512 }, extendedMetricsSampledAt: 1234, extendedMetricsFresh: true });
assert.deepEqual(await ctx.system.metrics(), { cpuPercent: 12, memUsedPercent: 34, gpuPercent: 56, diskUsedPercent: 78, battery: { percent: 80, charging: true }, network: { downloadBytesPerSecond: 1024, uploadBytesPerSecond: 512 }, extendedMetricsSampledAt: 1234, extendedMetricsFresh: true });
