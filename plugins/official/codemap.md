...
| `openpets.anxiety-aid-tools` | Calm-practice companion of anxietyaidtools.com; drives the host-rendered Calm 4-6 breathing session overlay around the pet, the science-backed Info window (AAT logo, linked studies), and pause/resume/stop pet-menu controls. Fully localized (7 locales). | `ui.session`, `commands`, `ui.menu`, `assets` |
