...
export type LogScope = "app" | "ipc" | "lease" | "pet.default" | "pet.agent" | "pet.window" | "pet.wayland" | "plugin" | "state" | "tray" | "ui" | "remote" | "teams" | "terminal-focus" | "window-tracker" | "capabilities";
