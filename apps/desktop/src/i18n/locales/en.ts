...
export const en = {
  ...
  "settings.providers.modal.subtitle": "Configure model endpoints, API keys, and active companion roles.",
  ...
  "settings.providers.modal.group.custom": "Custom",
  ...
  "settings.providers.modal.key.label": "API Key / Credential",
  ...
  "settings.providers.modal.key.note": "Keys are stored securely in your OS keychain / encrypted host store.",
  ...
  "settings.providers.modal.advanced": "Advanced Configuration (Headers, Custom Auth, Slug ID)",
