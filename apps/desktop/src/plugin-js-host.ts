...
export const sdkCallHandlers: Record<PluginSdkRoute, SdkCallHandler> = {
  ...
  "ui.session": (sdk, args) => sdk.ui.session(args[0]),
  "ui.sessionUpdate": (sdk, args) => sdk.ui.sessionUpdate(args[0], args[1]),
  "ui.sessionPause": (sdk, args) => sdk.ui.sessionPause(args[0]),
  "ui.sessionResume": (sdk, args) => sdk.ui.sessionResume(args[0]),
  "ui.sessionStop": (sdk, args) => sdk.ui.sessionStop(args[0]),
  "ui.sessionClose": (sdk, args) => sdk.ui.sessionClose(args[0]),
  "ui.sessionSubscribe": (sdk, args, runCallback) => sdk.ui.sessionSubscribe(args[0], callbackOf(runCallback, args[1]) as never),
