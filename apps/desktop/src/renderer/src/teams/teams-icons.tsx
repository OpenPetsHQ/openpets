...
export function NetworkPinIcon({
...
export function HeartHandshakeIcon({ className = "w-5 h-5" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function FeelingGoodIcon({ className = "w-4 h-4" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function FeelingSteadyIcon({ className = "w-4 h-4" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function FeelingStretchedIcon({ className = "w-4 h-4" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function FeelingStrugglingIcon({ className = "w-4 h-4" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function FeelingNeedSupportIcon({ className = "w-4 h-4" }: { className?: string } = {}) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
