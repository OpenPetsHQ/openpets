import { normalizeLanPetId, type LanClientRecord, type LanEdge, type LanMode, type LanPetRecord, type LanPoint, type LanState, type LanTopology } from "./lan-contract.js";
