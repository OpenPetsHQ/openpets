...
const api = {
  ...
  getManagerCheckInsSnapshot: () => ipcRenderer.invoke("openpets:manager-check-ins-snapshot"),
  syncManagerCheckIns: () => ipcRenderer.invoke("openpets:manager-check-ins-sync"),
  getManagerCheckInsHistory: (cursor) => ipcRenderer.invoke("openpets:manager-check-ins-history", cursor),
  submitManagerCheckIn: (input) => ipcRenderer.invoke("openpets:manager-check-ins-submit", input),
  setManagerCheckInScheduledOffersPaused: (paused) => ipcRenderer.invoke("openpets:manager-check-ins-set-scheduled-offers-paused", paused),
