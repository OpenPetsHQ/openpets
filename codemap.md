...
| `infra/linux-vms/` | Reproducible VMware/Vagrant Linux desktop test VMs (GNOME, KDE X11, COSMIC), guest provisioning, and the host `vm` driver; see `docs/development.md`. | — |
